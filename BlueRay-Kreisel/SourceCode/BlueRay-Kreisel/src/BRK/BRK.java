...
public class BRK {        
    ...
    // Newsletter Object
    public CNewsletter myNewsletter = new CNewsletter();
    ...
    public ArrayList<CBluRay> searchBR(CCustomer _Me, String _Arg)
    {
        ...
        {
            if (b.getTitle().equalsIgnoreCase(_Arg) || b.getGenre().equalsIgnoreCase(_Arg))
            {
                retSearchBR.add(b);
            }
        }
    ...
    /**
     * render a list of Customer-objects
     * @param _List
     */
    public void printCustomerList(ArrayList<CCustomer> _List){
        for(CCustomer c : _List)
        {
...
//        
         // TestUser
//        CCustomer userEckardt = new CCustomer("Eckardt", "Marco", "01.01.1995", "ma.ec@fh.de", "123456", myBRK);
//        CCustomer userWagner = new CCustomer("Wagner", "Christoph", "01.01.1995", "ch.wa@fh.de", "123456", myBRK);
//        
//        myBRK.myCustList.add(userEckardt);
//        myBRK.myCustList.add(userWagner);
//
...
//        
         // create test-bluray
//        CBluRay myBR = new CBluRay( userEckardt, BRState.OWNER, "Batman", "Action", 12);
//        myBR = new CBluRay( userEckardt, BRState.OWNER, "Titanic", "Drama", 0);
//        myBR= new CBluRay( userWagner, BRState.OWNER, "Minions", "Trickfilm", 0);
//        myBR = new CBluRay( userWagner, BRState.OWNER, "Titanic", "Drama", 0);
//        
...
//
         // test show all
//        myBRK.printBRList(myBRK.showAllBR(mySessionUser));
//        
         // test delete BR
